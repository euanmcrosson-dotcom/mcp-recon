...
const TRAVERSAL_PAYLOADS: Array<{ value: string; reason: string }> = [
	{ value: "../etc/passwd", reason: "POSIX dot-dot traversal" },
	{
		...
		reason: "Windows dot-dot traversal",
	},
	...
	{
		value: "/sandbox/../../../etc/passwd",
		reason: "in-sandbox prefix + traversal",
	},
	{
		value: "/sandbox/%2e%2e/etc/passwd",
		reason: "percent-encoded traversal in path",
	},
