...
const URL_PAYLOADS: Array<{ value: string; reason: string }> = [
	{
		value: "https://attacker.example@victim.example/",
		reason: "userinfo-splitting",
	},
	{
		value: "https://victim.example/@attacker.example/",
		reason: "fake-userinfo segment",
	},
	...
	{ value: "http://127.0.0.1/", reason: "loopback IP literal" },
	{
		...
		reason: "AWS instance metadata",
	},
	{ value: "http://[::]/", reason: "IPv6 unspecified" },
	{ value: "http://0.0.0.0/", reason: "IPv4 unspecified" },
	{
		value: "http://example.com\\.attacker.com/",
		reason: "backslash-host trick",
	},
