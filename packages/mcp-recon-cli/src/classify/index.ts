...
import { extractToolFacts, type ToolFacts } from "../fuzz/schema.js";
...
function classifyTool(
  ...
  const schemaFired: Array<{ data_class: DataClass; weight: number; reason: string }> = [];
...
function pushEvidence(map: Map<DataClass, number[]>, dc: DataClass, w: number): void {
